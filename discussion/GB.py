...
if __name__ == "__main__":
    data_train= pd.read_csv(r"H:\library\QDF-Donor\dataset\p\train.csv").sample(frac=1).reset_index(drop=True)
    data_test=pd.read_csv(r"J:\methods\pm1.csv").sample(frac=1).reset_index(drop=True)
